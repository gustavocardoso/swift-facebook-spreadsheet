  ...
  try {
    ...
    if (data) {
      ...
      data.forEach(async (item, index) => {
        ...
        //     `https://graph.facebook.com/v9.0/${item.ad_id}/leads?access_token=${process.env.FACEBOOK_API_ACCESS_TOKEN}&fields=field_data,retailer_item_id`
        //   )

        //   const leadsData = await leadsResponse.data
